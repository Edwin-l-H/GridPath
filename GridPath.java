public class GridPath 
{
    ...
    public Location getNextLoc(int row, int col) 
    {
        ...
        //If the row requested is at the border, it would keep "below" at Integer.MAXVALUE there is no row below the bottom row.
        //Keeping "below" at Integer.MAXVALUE will ensure that "right" gets returned if it exists.
    ...
    public int sumPath(int row, int col) 
    {
        ...
        //This while statement ensures that the path stays within the grid
